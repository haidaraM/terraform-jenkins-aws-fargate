...
resource "aws_route53_record" "certificate_validation_record" {
  count   = var.route53_zone_name != "" ? 1 : 0
  name    = aws_acm_certificate.master_certificate.0.domain_validation_options.0.resource_record_name
  type    = aws_acm_certificate.master_certificate.0.domain_validation_options.0.resource_record_type
